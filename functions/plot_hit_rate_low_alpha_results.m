function plot_hit_rate_low_alpha_results(results, varargin)
%PLOT_ALPHA_PHASE_LOW_RESULTS Plot phase-dependent hit rate, compare with Mathewson 2009 (low-alpha).
